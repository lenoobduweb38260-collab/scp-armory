...
function ENT:Draw()
	...
	cam.Start3D2D(pos, ang, 0.06)
		...
		draw.SimpleText(SCPArmory.T("ARMURERIE"), "SCPArmory_3D2D", 0, -28, COL_ACCENT, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText(SCPArmory.T("Fondation SCP — Appuyez sur [E]"), "SCPArmory_3D2D_Small", 0, 22, COL_TEXT, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	cam.End3D2D()
end
